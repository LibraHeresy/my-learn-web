    ...
    steps: [
      {
        ...
        hint: "图片链接可以从维基百科获取。在维基百科上搜一位你喜欢的作曲家，右键复制图片地址。如果暂时找不到，也可以用 `https://placehold.co/400x300/E8D5B7/8B2E2E?text=Composer` 作为占位图。",
        starterCode: {
      ...
      },
      {
        ...
        task: "把名片改成你喜欢的音乐家。调整颜色、字体、布局，直到你满意为止。尝试至少修改 5 处不同的 CSS 属性。",
