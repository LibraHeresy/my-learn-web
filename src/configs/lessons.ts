...
// （500ms 后）`,
...

  {
    id: "ai-what-is",
    chapterId: "ai-basics",
    trackId: "ai-collaboration",
    order: 1,
    title: "AI 能做什么、不能做什么",
    musicAnalogy: "「AI 是你的乐团，但指挥棒在你手里——它演奏技巧一流，但不知道下一段该进入哪个调。」",
    mode: "local",
    starterCode: { html: "", css: "", js: "" },
    sections: [
      {
...

  {
    ...
    order: 2,
    title: "编程思维的进化",
    musicAnalogy: "「手写汇编像敲击每一根琴弦——精准但低效。高级语言像看谱演奏——更快但依赖乐谱。Prompt 像指挥——你不演奏，但你知道应该是什么声音。」",
    mode: "local",
    starterCode: { html: "", css: "", js: "" },
    sections: [
      {
        type: "explain",
        title: "一、编程的三次抽象飞跃",
        content: "编程的历史，是一部\"抽象层次不断上升\"的历史。每一次上升，都让你离机器的思维方式更远，离人类的思维方式更近。\n**第一层：机器码 / 汇编（1940s-1950s）。** 你需要告诉 CPU 把哪个寄存器的值挪到哪个内存地址。写一个\"Hello World\"要十几行指令。你像手工打磨零件的工匠——每一刀都在掌控之中，但一天只能做一件活。\n**第二层：高级语言（1960s-2010s）。** FORTRAN、C、Java、Python、JavaScript——这些语言把\"机器指令\"抽象成了\"人类可读的逻辑\"。你写 `print(\"Hello\")`，编译器把它翻译成几百条机器指令。效率提升了几百倍。你从工匠变成了工程师。\n**第三层：Prompt（2020s）。** 你写\"帮我写一段 JS 代码，从 API 取数据，显示成列表，加上加载状态和错误处理\"。AI 生成完整的实现。你从写代码的人变成了描述需求的人。\n**每一次抽象，都在做同一件事：把你从\"怎么做\"中解放出来，让你专注于\"做什么\"和\"为什么\"。**",
      },
      {
        type: "explain",
        title: "二、你的角色在变化",
        content: "在前八章，你学了怎么写 HTML、CSS、JS、Vue。那是让你**成为第二层的专家**——你能看懂代码、写出代码、调试代码。这些能力不会因为 AI 的出现而贬值，反而更值钱了。\n为什么？因为 AI 是第三层的工具。你用第三层的工具生成代码，然后**用你的第二层能力去判断它**。没有第二层的能力，你就不知道 AI 生成的东西对不对。\n在 AI 时代，前端开发者的工作流从：\n**之前：** 理解需求 → 设计实现方案 → 写代码 → 调试 → 上线\n**现在：** 理解需求 → 设计实现方案 → 向 AI 描述需求 → 审查 AI 生成代码 → 调试（AI 辅助）→ 整合 → 上线\n写代码的时间减少了，但\"理解需求\"\"设计方案\"\"审查代码\"\"判断对错\"——这些比写代码更难的事情，全是你来做。AI 把体力活自动化了，脑力活留给了你。**这其实更好玩。**",
      },
      {
        type: "explain",
        title: "三、\"AI 会替代程序员吗？\"",
        content: "这个问题被问了几百万次。直接的答案是：**AI 会替代那些只会\"翻译需求→代码\"的程序员。不会替代那些能\"理解用户真正需要什么→设计解决方案→判断实现是否正确\"的程序员。**\n翻译需求→代码，是 AI 最擅长的事——有标准答案，有海量样本。\n理解用户真正需要什么——这是人类的专属领域。用户说的和他们真正想要的是两回事。这种判断依赖共情、直觉、对话，AI 做不了。\n设计解决方案——在多个可行方案中做选择，每个方案各有取舍，这不取决于技术，取决于你的价值观和品味。\n判断实现是否正确——你的代码跑在真实用户的生产环境里，任何 bug 都有代价。谁来承担这个代价？AI 不承担。你和你的团队承担。\n**把 AI 想象成世界上最博学但最不负责任的同事。** 他可以给你一百种方案，每一种都看起来合理。但说\"我们用这个方案\"的人，是你。对这个决定承担责任的人，也是你。",
      },
    ],
  },

  {
    ...
    trackId: "ai-collaboration",
    order: 3,
    title: "写好 Prompt 的核心原则",
    musicAnalogy: "「好的指挥不需要说出每一个音符——只需要指出方向、速度、情绪，乐团就知道怎么演奏。好的 Prompt 也一样。」",
    mode: "local",
    starterCode: { html: "", css: "", js: "" },
    sections: [
      {
...

  {
    ...
    order: 4,
    title: "用 AI 调试和解释错误",
    musicAnalogy: "「好的排练不是不犯错——是每次犯错都知道为什么，然后下次不再犯。」",
    mode: "local",
    starterCode: { html: "", css: "", js: "" },
    sections: [
      {
  ...
  {
    id: "ai-plan",
    chapterId: "ai-project",
    trackId: "ai-collaboration",
    order: 1,
    title: "用 AI 做项目规划",
    musicAnalogy: "「作曲之前，先想清楚你要写交响曲还是小步舞曲。AI 能帮你展开配器，但决定写什么——是你。」",
    mode: "local",
    starterCode: { html: "", css: "", js: "" },
    sections: [
      {
...

  {
    ...
    order: 2,
    title: "用 AI 搭项目脚手架",
    musicAnalogy: "「乐团已经就座，乐器已经调好——现在只需要你的第一个手势。」",
    mode: "local",
    starterCode: { html: "", css: "", js: "" },
    sections: [
      {
...

  {
    ...
    order: 3,
    title: "用 AI 实现组件",
    musicAnalogy: "「每个乐手都有自己的谱子——你的任务是确保所有谱子合在一起是一首完整的曲子，而不是四个声部各演各的。」",
    mode: "local",
    starterCode: { html: "", css: "", js: "" },
    sections: [
      {
...

  {
    ...
    trackId: "ai-collaboration",
    order: 4,
    title: "完整项目：从 Prompt 到产品",
    musicAnalogy: "「最后一课——上台。没有指挥台，没有乐谱架。你和你的 AI 乐团，面对空白的观众席。灯光亮了。」",
    mode: "local",
    starterCode: { html: "", css: "", js: "" },
    sections: [
      {
