...
:::analogy
JavaScript 只用了十天设计出来——就像在餐巾纸上随手画的草图，后来却成了整个互联网的通用语言。
:::
...
这不是技术竞争，这是平台垄断者对挑战者的绞杀。IE3 在功能上全面落后于 Netscape Navigator 3——它的 CSS 支持弱得可怜，JavaScript 实现又慢又奇怪（后来的 IE5/IE6 更是出了著名的盒子模型 bug，坑了前端开发者整整十年）。但免费就是最狠的武器。当 Netscape 在收费、IE 在说"我不要钱"时，大多数人不会在乎谁的技术更好。
...
2004 年，从 Netscape 灰烬中重生的 Mozilla 发布了 Firefox 1.0。第一个月下载量超过一千万。到 2009 年底，Firefox 拿下了全球约 30% 的份额，用几年时间从微软嘴里撬走了近三成用户。
...
:::recap
浏览器大战虽然硝烟已散，但它的遗产至今还在——JavaScript 就是在这场战争中诞生的，CSS 也是。竞争推动创新，但分裂也困扰了开发者十几年。后来的标准制定（W3C）就是为了避免再出现"这个网站只支持 XX 浏览器"的糟糕体验。
:::
