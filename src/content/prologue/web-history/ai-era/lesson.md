...
:::analogy
AI 时代编程的核心不再是写代码的速度，而是提出正确问题的能力——从"会做题"变成了"会出题"。
:::
...
但真正改变编程世界的，是另一件事。
2017 年，Google 的一个研究团队发表了一篇论文：《Attention is All You Need》。标题像一句宣言，内容是提出了一个叫 **Transformer** 的神经网络架构。它用了一种叫"自注意力机制"的方法，让机器第一次能"理解上下文"——不是看一个词前面的几个词，而是同时看整个段落的所有词。
...
2020 年，GPT-3 发布，1750 亿参数。它能写文章、写代码、做翻译、写诗、模仿任何人的语气。两年前的 2018 年，微软宣布收购 GitHub——这个组合在后来看，意味深长。
:::
