# GitHub — 把你的作品"发布到公共图书馆"

:::analogy
GitHub 就像是把你的代码发布到公共图书馆——你的项目有了一个公开的地址，别人可以看到、使用、贡献。它也是程序员界的 LinkedIn——你的 GitHub 主页就是你的技术名片。
:::
...
:::recap
你学会了把本地项目推送到 GitHub——在 GitHub 创建仓库，用 git remote add 关联远程地址，git push 上传代码。从此你的代码有了云端备份，别人也能在线看到你的作品。
:::
